...
export default class CadastroFinalScreen extends React.Component {
  ...
  render() {
	...
	if(this.state.imagemMotorista){
		infosMotorista = (
			<View style={{justifyContent:'center'}}>
				...
				<Item style={{marginTop:27.5,borderColor:'transparent',width:328,justifyContent:'center'}}>
					<Button disabled={isDisabled} onPress={this._enviaCodigo} style={this.getEstadoBotao(isDisabled)}>
		...
		finalizarPassageiro = (
			<Item style={{marginTop:27.5,borderColor:'transparent',width:328,justifyContent:'center'}}>
				<Button onPress={this._enviaCodigo} style={{alignSelf: "center",width:157.5,height:40,backgroundColor:'#ffca28',color:'#000',elevation:0}}>
